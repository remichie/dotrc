...
"    nmap <unique> /b :call Gdb_command("break
""    ".bufname("%").":".line("."))<CR><Space>
"    nmap <unique> /run :Gdb run<CR><Space>
"    nmap <unique> /s :<C-U>Gdb step<CR>
"    nmap <unique> /n :<C-U>Gdb next<CR>
"    nmap <unique> /finish :Gdb finish<CR>
"    nmap <unique> <Leader><F8> :<C-U>Gdb continue<CR>
"    vmap <unique> <Leader><C-P> "gy:Gdb print <C-R>g<CR>
"    nmap <unique> <Leader><C-P> :call Gdb_command("print "
"    .expand("<cword>"))<CR> 
endfunction
